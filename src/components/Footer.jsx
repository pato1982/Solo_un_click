export default function Footer() {
  return (
    <footer className="bg-primary text-white pt-8 pb-3 px-6">
      ...
      <div className="max-w-7xl mx-auto pt-2 mt-4 border-t border-white/10 flex flex-col md:flex-row items-center justify-center gap-24">
        <p className="text-white/40 text-[10px] font-bold tracking-widest">
          © 2026 Solo a un Click. Todos los derechos reservados.
        </p>
        <p className="text-white/40 text-[10px] font-bold tracking-widest">
