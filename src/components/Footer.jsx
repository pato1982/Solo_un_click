  ...
  return (
    <footer className="bg-primary text-white pt-6 sm:pt-8 pb-3 px-3 sm:px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="flex justify-center">
              <div>
                ...
                <ul className="space-y-1 text-[9px] font-normal text-white/50">
                  <li><a className="hover:text-accent transition-colors" href="#">Términos</a></li>
                  <li><a className="hover:text-accent transition-colors" href="#">Datos</a></li>
                  <li><a className="hover:text-accent transition-colors" href="#">Privacidad</a></li>
                  <li><a className="hover:text-accent transition-colors" href="#">Cookies</a></li>
                </ul>
              </div>
            </div>
            <div className="flex justify-center">
              ...
              <div>
                ...
                <ul className="space-y-1 text-[9px] font-normal text-white/50">
                  ...
                  <li className="flex items-center gap-1.5">
                    ...
                    <a className="hover:text-accent transition-colors" href="#">+56 9 1234 5678</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="hidden sm:grid sm:grid-cols-3 md:grid-cols-[1fr_1fr_1fr_1fr_1fr] gap-8">
          ...
          <div className="md:px-10">
            ...
            <ul className="space-y-2 text-xs font-normal text-white/50">
              <li><a className="hover:text-accent transition-colors" href="#">Términos y condiciones</a></li>
              <li><a className="hover:text-accent transition-colors" href="#">Protección de datos</a></li>
              <li><a className="hover:text-accent transition-colors" href="#">Política de privacidad</a></li>
              <li><a className="hover:text-accent transition-colors" href="#">Política de cookies</a></li>
            </ul>
          </div>
          <div className="md:px-10">
